...
For language-specific development setup, coding style, and CI details, see the contributing guide in each SDK directory (e.g., [`rust/CONTRIBUTING.md`](rust/CONTRIBUTING.md), [`java/CONTRIBUTING.md`](java/CONTRIBUTING.md), [`ts/CONTRIBUTING.md`](ts/CONTRIBUTING.md)).
