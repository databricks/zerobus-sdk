...
pub(super) struct StreamOpenParams {
    ...
    /// Avro writer schema JSON, set when the `avro` feature carries a schema and
    /// `None` otherwise. Threaded unchanged into the create request.
    pub(super) avro_schema_json: Option<String>,
}
